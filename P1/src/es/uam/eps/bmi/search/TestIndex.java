...
public class TestIndex {
	...
	/**
	 * Metodo autxiliar para el test de un index. Crea el indice a partir de
	...
	/**
	 * Metodo auxiliar para el test de un index. Carga el indice a partir de
	 * los argumentos dados.
	 *
	 ...
	 *
	 * @param outputFile Fichero en el que almacenar el resultado. El
	 * fichero se compone de 5 columnas: termino frecuencia numdocs tf idf
	...
	private static void _test(String outputFile, Index Idx) {
		...
		try {
			...
			/**
			 * La penalizacion al ordenar es despreciable frente al
			 * tiempo de generacion del indice
			 */
