...
public class GenericCrawler {
    ...
    dom.add("http://stackoverflow.com/");
    ...
    //le paso la primera url
     url = new URL("https://es.wikipedia.org/w/index.php?title=Miner%C3%ADa_de_datos&redirect=no");
     crawl(url,crawler);
    ...
    public static void crawl(URL url,GenericCrawler crawler ) throws IOException{
      ...
      (new FileWriter(path+"/"+pagina+".html"));
      ...
      BufferedWriter grafo = new BufferedWriter
      (graph);
      ...
      for(int k=0;k<urlstovisit.size();k++){
          ...
          if(!pagesVisited.contains(tovisit)){
              ...
              BufferedReader reader1 = new BufferedReader
               (new InputStreamReader(nuevaUrl.openStream()));
